...
public class IncidentServiceTest {
    ...
    private final IncidentService incidentService = new IncidentService(workScheduleRepository,incidentRepository, incidentReportRepository, ambulanceRepository, ambulanceService, dispatcherRepository);
